...
class Exam extends Model
{
    ...
    protected $fillable = ['title','totalquestion','mfr','mfw','minutes','description','programme','coursecode','lecturer_id','questiontoshow','retry','academicyear','semester','fullname'];
