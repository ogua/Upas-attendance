<div class="row">
  <div class="col-md-4">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Add Couse Diploma Level 100 <span class="badge badge-pill badge-secondary">CODE (PDBA)</span></h3>
      </div>
      <div class="box-body">
 ...
 <div class="col-md-8">
  <div class="box box-primary">
    ...
    <div class="box-body" wire:ignore>
     <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="{{route('add-course-diploma1-edit', ['id'=>$row->id])}}" class="btn btn-info" ><i class='fa fa-pencil-square-o'></i></a>

            <a href="" class="btn btn-danger" wire:click.prevent="deletecourse('{{$row->code}}')" onclick="return confirm('Are You Sure ?')"><i class='fa fa-trash'></i></a>
          </td>
        </tr>
        @endforeach
      </tbody>
