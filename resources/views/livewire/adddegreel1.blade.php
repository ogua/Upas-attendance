  ...
  <div class="col-md-4">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Add Couse Level 100 <span class="badge badge-pill badge-secondary">CODE (BGEC)</span></h3>
      </div>
      <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($course as $row)
                    ...
                    <td>
                      <a href="{{route('add-course-degreel1-edit', ['id'=>$row->id])}}" class="btn btn-info" ><i class='fa fa-pencil-square-o'></i></a>
