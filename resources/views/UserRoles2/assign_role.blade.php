...
@section('title')
  @lang('school.pagetitle') | Add Permissions
@endsection
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('assingn-role-to-permission-save') }}">
          ...
          $submenu = App\Models\SubMenu::where('menu_id',$id)->get();

          $submenuper = App\Models\Menupermission::where('menu_id',$id)->first();
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <?php
                $permission = App\Models\Menupermission::where('sub_menu_id',$sub->id)->get();
                ?>
