            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  ...
                  @else
                  @hasanyrole('Student')
                  <a href="{{ route('students-profile-info-view') }}" class="btn btn-default btn-flat">Profile</a>

                  @else
                  <a href="{{ route('Staffprofile') }}" class="btn btn-default btn-flat">Profile</a>
                  @endhasanyrole
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li><a href="{{ route('pay_mandatory_fees') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>Pay Mandatory Fees</a></li>
    <li class="treeview">
      <a href="#"><i class="fa fa-circle"></i>Other Services
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="{{ route('other_services_fees') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>Request</a></li>
        <li><a href="{{ route('submiited_other_services_fees') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>Submission</a></li>
        <li><a href="{{ route('pay_other_services_fees') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>Pay</a></li>
      </ul>
    </li>
    <li><a href="{{ route('print_statement') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>Print Statement</a></li>

    <li><a href="{{ route('ledge-account') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole><i class="fa fa-circle"></i>wallet Ledger report</a></li>

    

    <li class="treeview">
      <a href="#"><i class="fa fa-circle"></i>Wallets
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="{{ route('top_up_wallet') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole ><i class="fa fa-circle"></i>Top Up Wallet</a></li>

        <li><a href="{{ route('paystack-all-transactions-student') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole ><i class="fa fa-circle"></i>ALL Paystack Transactions</a></li>
      </ul>
    </li>


    <li class="treeview">
      <a href="#"><i class="fa fa-circle"></i>Transactions
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
       <li><a href="{{ route('transaction_history_student') }}" @hasanyrole('is_admin|is_superAdmin') style=" pointer-events: none;" @endhasanyrole ><i class="fa fa-circle"></i>Transaction History</a></li>
      </ul>
    </li>
  </ul>
</li>
...
<li><a href="{{route('passconfirm')}}"><i class="fa fa-circle text-red"></i> <span>Lock Screen</span></a></li>
</ul>
<!-- /.sidebar -->
