...
@section('title')
  OSMS | Assign Course(s) To Lecturers
@endsection
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Assign Course(s)</h3>
      </div>
      <div class="box-body">
                ...
                <tbody>
                  @foreach($staff as $row)
                    <tr>
                      ...
                      <td>{{$row->number}}</td>
                    <td>
                        <a href="{{route('assign-course-lecturer', ['id'=>$row->user_id])}}" class="btn btn-success" ><i class='fa fa-reply'></i> Assign Course</a> 
