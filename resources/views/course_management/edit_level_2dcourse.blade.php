  ...
  <div class="col-md-5 col-md-offset-3">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Edit Diploma Course Level 200 <span class="badge badge-pill badge-secondary">CODE (PDBA)</span></h3>
      </div>
      <div class="box-body">
        <form action="{{route('add-course-diploma2-save')}}" method="POST">
          @csrf
