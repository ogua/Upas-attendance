    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <h2>Check Courses To Register </h2>
            <form action="{{route('add-course-programme-BPRM-second-save-l2',['code'=>$procode->code])}}" method="POST">
              @csrf
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                      <th colspan="4">Level 200 Second Semester Registered Courses</th>
                    </tr>
                    <tr>
                      <th>Course code</th>
                      <th>Title</th>
...
<form id="delete_doc_{{$row->id}}" 
  action="{{ route('course-remove-second-BPRM-l2', ['id'=> $row->id ]) }}" method="POST" style="display: none;">
