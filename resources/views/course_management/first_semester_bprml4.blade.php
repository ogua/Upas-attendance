  ...
  <div class="col-md-6">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">{{$procode->name}} Level 400 First Semester Courses</h3>
      </div>
      <div class="box-body">
        <h3>Check Courses To Register Level 400 Courses </h3>
            <form action="{{route('add-course-programme-BPRM-first-save-l4',['code'=>$procode->code])}}" method="POST">
              @csrf
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                      <th colspan="4">Level 400 First Semester Registered Courses</th>
                    </tr>
                    <tr>
                      <th>Course code</th>
                      <th>Title</th>
...
<form id="delete_doc_{{$row->id}}" 
  action="{{ route('course-remove-first-BPRM-l4', ['id'=> $row->id ]) }}" method="POST" style="display: none;">
