  ...
  <div class="col-md-6">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">{{$procode->name}} Lvel 400 Second Semester Courses</h3>
      </div>
      <div class="box-body">
        <h2>Check Courses To Register </h2>
            <form action="{{route('add-course-programme-BPRM-second-save-l4',['code'=>$procode->code])}}" method="POST">
              @csrf
              <input type="hidden" value="Second Semester" class="form-control" name="semester">
              ...
              <input type="hidden" value="{{$procode->code}}" class="form-control" name="progcode">
                ...
                <p><a href="{{route('add-course-degreel4')}}">Cant Find Course, Add Course</a></p>
            </form> 
      </div>
    </div>
  </div>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                      <th colspan="4">Level 400 Second Semester Registered Courses</th>
                    </tr>
                    <tr>
                      <th>Course code</th>
                      <th>Title</th>
...
<form id="delete_doc_{{$row->id}}" 
  action="{{ route('course-remove-second-BPRM-l4', ['id'=> $row->id ]) }}" method="POST" style="display: none;">
