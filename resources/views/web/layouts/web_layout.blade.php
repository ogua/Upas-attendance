...
<body>
	...
	<header>
			...
			<div class="container">
				<div class="row">
					<h1 class="text-capitalize text-white col-7">
						<i class="fas fa-book text-dark bg-white p-2 rounded-circle mr-3"></i>welcome to OSMS</h1>
					<!-- social icons -->
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
				<div class="row">
					<a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="{{ route('home')}}">OSMS</a>
						...
						<div class="row">
							<div class="col-sm-4 nav-middle">
								...
								<div class="agile-addresmk">
									...
									<a href="mailto:ogusesitsolutions@gmail.com">ogusesitsolutions@gmail.com</a>
									</p>
								</div>
							</div>
							...
							<div class="col-sm-4 col-6 top-login-butt text-right mt-sm-2">
								@if(!Auth::user())
									<a href="{{route('login')}}" class="button-head-mow3 text-white">Login</a>
								@endif
							</div>
						</div>
					</div>
	...
	<footer>
			...
			<div class="row py-xl-5 py-sm-3">
				<div class="col-lg-6 map">
					...
					<div class="conta-posi-w3ls p-4 rounded">
						...
						<p>Animantua Rd,
							<span>Tsuibleoo street,</span> Accra, Ghana</p>
					</div>
				</div>
				<div class="col-lg-6 contact-agileits-w3layouts mt-lg-0 mt-4">
					...
					<p class="para-agileits-w3layouts text-white">
						<i class="fas fa-map-marker pr-3"></i>Tsuibleoo Rd,Accra</p>
					<p class="para-agileits-w3layouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i>+233 27 218 5090</p>
					<p class="para-agileits-w3layouts">
						<i class="far fa-envelope-open pr-2"></i>
						<a href="mailto:ogusesitsolutions@gmail.com" class=" text-white">ogusesitsolutions@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© <?php echo date('Y');?> OguSes IT Solutions. All Rights Reserved | Design by
						<a href="http://ogusesitsolutions.com" target="_blank">OguSes IT Solutions</a>
					</p>
					<!-- social icons -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "578789949458553");
