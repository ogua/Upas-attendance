...
<script>
  $(function () {
    ...
    function getEvents(){
      $.ajax({
        url: '{{route('lms-lec-callendar-get',['code' => $code])}}',
        type: 'get',
        dataType: 'json',
    ...
    $('#add-new-event').click(function (e) {
      ...
      $.ajax({
        ...
        url: '{{route('lms-lec-callendar-save')}}',
        type: 'POST',
        data: {_token: _token, title: title, start: start, end: end, currColor: currColor, code: code},
        success: function(data){
